...
namespace CompileTime
{
	...
	struct Signature4 : public Noninstancable
	{
	private:
	...
	struct Signature8 : public Noninstancable
	{
	private:
	...
	DEBUG_ONLY(
		template <char C0, char C1, char C2, char C3, char C4>
		const char	Signature4::Pack< C0, C1, C2, C3, C4 >::name[] = { C0, C1, C2, C3, C4, 0 };

		template <char C0, char C1, char C2, char C3, char C4, char C5, char C6, char C7, char C8, char C9>
		const char	Signature8::Pack< C0, C1, C2, C3, C4, C5, C6, C7, C8, C9 >::name[] = { C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, 0 };
	)

	template <Signature4::value_t Value>
	const char Signature4::Unpack< Value >::value[] = {
	...
	template <Signature8::value_t Value>
	const char Signature8::Unpack< Value >::value[] = {
		_ctime_hidden_::_UnpackChar< _value_t, Value, 0 >::value,
		_ctime_hidden_::_UnpackChar< _value_t, Value, 1 >::value,
		_ctime_hidden_::_UnpackChar< _value_t, Value, 2 >::value,
		_ctime_hidden_::_UnpackChar< _value_t, Value, 3 >::value,
