...
namespace CompileTime
{
	...
	public:
		...
		// MaxSizeOf
		static constexpr usize	MaxSizeOf ()
		{
			return ForEach< _ctime_hidden_::TTypeList_MaxSize, ValueToType<usize, 0> >::value;
		}

		// MaxAlignOf
		static constexpr usize	MaxAlignOf ()
		{
			return ForEach< _ctime_hidden_::TTypeList_MaxAlign, ValueToType<usize, 0> >::value;
		}
		...
		// Front
		using Front		= typename Get< 0 >;

		// Back
		using Back		= typename Get< Length-1 >;
