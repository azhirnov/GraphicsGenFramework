...
namespace _platform_
{
	...
	public:
		...
		bool Wait (const CriticalSection &mutex, uint timeMiliseconds)
		{
			int result = ::SDL_CondWaitTimeout( _cv, mutex._mutex, timeMiliseconds );
			ASSERT( result != -1 );
			return result != -1;
		}
	};
...
#include "../Base/SyncEventEmulation.h"
