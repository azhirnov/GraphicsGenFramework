...
namespace _platform_
{
	...
	{
		// type cast //
#		define type_cast( _val_ )	& ReferenceCast< volatile typename CompileTime::Similar<T>::Signed,	volatile T >( _val_ )
#		define itype_cast( _val_ )  & ReferenceCast< volatile typename CompileTime::Similar<T>::Int,	volatile T >( _val_ )
#		define ctype_cast( _val_ )	ReferenceCast< const    typename CompileTime::Similar<T>::Int,		const    T >( _val_ )
#		define rtype_cast( _val_ )	ReferenceCast< const T, const typename CompileTime::Similar<T>::Int >( _val_ )
		...
		template <typename T>
		static void  _Set (volatile T * left, const T& right)
		{
			T prev;
			do {
				prev = *left;
		...
		template <typename T>
		static void  Set (volatile T & left, const T& right) {
