...
namespace _platform_
{
	...
	public:
		...
		Date &	FromMillisecondsSince1970 (ulong ms)	{ return _FromMilliseconds( 1970, ms ); }

		ulong	ToMillisecondsSinceEpoch () const		{ return _ToMilliseconds( 0 ); }
		Date &	FromMillisecondsSinceEpoch (ulong ms)	{ return _FromMilliseconds( 0, ms ); }
	...
	private:
		...
		Date& _FromMilliseconds (uint startYear, ulong ms);
	};
