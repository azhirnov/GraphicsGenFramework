...
namespace File
{
	...
	public:
		...
		static LzmaWFilePtr New (Bytes<usize> reserve = 0)
		{
...
namespace GXTypes
{
	typedef SHARED_POINTER_TYPE( File::LzmaRFile )	LzmaRFilePtr;
	typedef SHARED_POINTER_TYPE( File::LzmaWFile )	LzmaWFilePtr;
