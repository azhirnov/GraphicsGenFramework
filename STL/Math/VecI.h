...
#	endif
	...
	template <typename T>
	inline Vec<T,I> &  Vec<T,I>::InterpolateL (const Self &sVec1, const Self &sVec2, T tK)
	{
	...
	template <typename T>
	inline Vec<T,I> &  Vec<T,I>::InterpolateQ (const Self &sVec1, const Self &sVec2, const Self &sVec3, T tK)
	{
	...
	template <typename T>
	inline Vec<T,I>  Vec<T,I>::GetInterpolatedL (const Self &sVec, T tK) const
	{
		Self	ret;
	...
	template <typename T>
	inline Vec<T,I>  Vec<T,I>::GetInterpolatedQ (const Self &sVec1, const Self &sVec2, T tK) const
	{
		Self	ret;
	...
	*/
	...
	template <typename T>
	inline String  Vec<T,I>::ToString () const
	{
		String	str;
	...
	template <typename T>
	inline String  Vec<T,I>::ToStringFull () const
	{
