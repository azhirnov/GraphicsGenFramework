...
#	endif
		...
		public:
			...
			{
				return ToMask< IntFormat::value_t >( Max( sizeInBits - int(isSigned), IntFormat() ) );
			}
			...
			{
				typedef Vec< CompileTime::Similar< IntFormat::value_t >::Signed, 4 >	sign_t;
				typedef Vec< CompileTime::Similar< IntFormat::value_t >::Unsigned, 4 >	unsign_t;
