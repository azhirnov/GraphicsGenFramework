...
namespace _types_hidden_
{
	...
	public:
		...
		typedef Buffer< Value >						values_range_t;
		typedef Buffer< const Value >				const_values_range_t;
	...
	public:
		...
		usize Add (const Value &value)			{ return _memory.Add( value ); }
		usize Add (Value &&value)				{ return _memory.Add( RVREF( value ) ); }
	...
	struct Hash< _types_hidden_::BaseSet< Value, IsUnique, S, MC > > :
		private Hash< Buffer<const Value> >
	{
		typedef _types_hidden_::BaseSet< Value, IsUnique, S, MC >	key_t;
		typedef Hash< Buffer<const Value> >							base_t;
