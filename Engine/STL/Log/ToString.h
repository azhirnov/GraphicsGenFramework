...
*/
	...
	{
		return String("left: ") << value.left << ", bottom: " << value.bottom
...
*/
	...
	{
		return String("min( ") << ToString( value.Min() ) << " ), max( " << ToString( value.Max() ) << " )";
	}
...
*/
	...
	{
		return String("norm: (") << ToString( value.Normal() ) << "), dist: " << ToString( value.Distance() );
	}
