...
#define _GX_DIM_OPERATORS_TYPE( _op_, _value_, _type_, _memberOption_ ) \
	\
	forceinline Self&			operator _op_##= (const _type_ &right)						{ _value_ _op_##= (value_t) right _memberOption_;  return *this; } \
	forceinline constexpr Self  operator _op_    (const _type_ &right) const				{ return Self( _value_ _op_ (value_t) right _memberOption_ ); } \
	\
	forceinline constexpr friend Self operator _op_ (const _type_ &left, const Self &right)	{ return Self( (value_t) left _memberOption_ _op_ right._value_ ); }


#define _GX_DIM_OPERATORS_TEMPLATE( _op_, _value_, _memberOption_ ) \
	\
	forceinline template <typename _A_> Self&			operator _op_##= (const _A_ &right)			{ _value_ _op_##= (value_t) right _memberOption_;  return *this; } \
	forceinline template <typename _A_> constexpr Self  operator _op_    (const _A_ &right) const	{ return Self( _value_ _op_ (value_t) right _memberOption_ ); } \
	\
	forceinline template <typename _A_> \
	forceinline constexpr friend Self operator _op_ (const _A_ &left, const Self &right)			{ return Self( (value_t) left _memberOption_ _op_ right._value_ ); }
...
#define _GX_DIM_CMP_OPERATORS_TYPE( _value_, _type_, _memberOption_ ) \
	\
	forceinline constexpr bool operator == (const _type_ &right)	const		{ return this->_value_ == (value_t)( right _memberOption_ ); } \
	forceinline constexpr bool operator != (const _type_ &right)	const		{ return this->_value_ != (value_t)( right _memberOption_ ); } \
	forceinline constexpr bool operator >  (const _type_ &right)	const		{ return this->_value_ >  (value_t)( right _memberOption_ ); } \
	forceinline constexpr bool operator <  (const _type_ &right)	const		{ return this->_value_ <  (value_t)( right _memberOption_ ); } \
	forceinline constexpr bool operator >= (const _type_ &right)	const		{ return this->_value_ >= (value_t)( right _memberOption_ ); } \
	forceinline constexpr bool operator <= (const _type_ &right)	const		{ return this->_value_ <= (value_t)( right _memberOption_ ); } \
	\
	forceinline constexpr friend bool operator == (const _type_ &left, const Self &right)	{ return (value_t)( left _memberOption_ ) == right._value_; } \
	forceinline constexpr friend bool operator != (const _type_ &left, const Self &right)	{ return (value_t)( left _memberOption_ ) != right._value_; } \
	forceinline constexpr friend bool operator >  (const _type_ &left, const Self &right)	{ return (value_t)( left _memberOption_ ) >  right._value_; } \
	forceinline constexpr friend bool operator <  (const _type_ &left, const Self &right)	{ return (value_t)( left _memberOption_ ) <  right._value_; } \
	forceinline constexpr friend bool operator >= (const _type_ &left, const Self &right)	{ return (value_t)( left _memberOption_ ) >= right._value_; } \
...
#define _GX_DIM_CMP_OPERATORS_TEMPLATE( _value_, _memberOption_ ) \
	\
	template <typename _A_> forceinline constexpr bool operator == (const _A_ &right) const	{ return this->_value_ == (value_t)( right _memberOption_ ); } \
	template <typename _A_> forceinline constexpr bool operator != (const _A_ &right) const	{ return this->_value_ != (value_t)( right _memberOption_ ); } \
	template <typename _A_> forceinline constexpr bool operator >  (const _A_ &right) const	{ return this->_value_ >  (value_t)( right _memberOption_ ); } \
	template <typename _A_> forceinline constexpr bool operator <  (const _A_ &right) const	{ return this->_value_ <  (value_t)( right _memberOption_ ); } \
	template <typename _A_> forceinline constexpr bool operator >= (const _A_ &right) const	{ return this->_value_ >= (value_t)( right _memberOption_ ); } \
	template <typename _A_> forceinline constexpr bool operator <= (const _A_ &right) const	{ return this->_value_ <= (value_t)( right _memberOption_ ); } \
	\
	template <typename _A_> forceinline constexpr friend bool operator == (const _A_ &left, const Self &right)	{ return (value_t)( left _memberOption_ ) == right._value_; } \
	template <typename _A_> forceinline constexpr friend bool operator != (const _A_ &left, const Self &right)	{ return (value_t)( left _memberOption_ ) != right._value_; } \
	template <typename _A_> forceinline constexpr friend bool operator >  (const _A_ &left, const Self &right)	{ return (value_t)( left _memberOption_ ) >  right._value_; } \
	template <typename _A_> forceinline constexpr friend bool operator <  (const _A_ &left, const Self &right)	{ return (value_t)( left _memberOption_ ) <  right._value_; } \
	template <typename _A_> forceinline constexpr friend bool operator >= (const _A_ &left, const Self &right)	{ return (value_t)( left _memberOption_ ) >= right._value_; } \
