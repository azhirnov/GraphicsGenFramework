...
namespace OS
{
	...
	public:
		...
		static bool RecursiveFindFiles (StringCRef path, Filter filter, OUT Array<String> &fileNames);
...
*/
	template <typename T>
	template <typename B>
	inline bool BaseFileSystem<T>::_SearchForward (StringCRef dir, StringCRef name,
													GXTypes::uint depth, OUT String &result)
	{
		TODO("SearchForward");
		return false;
	}
