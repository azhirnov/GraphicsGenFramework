...
namespace ShaderEditor
{
	...
	class SinglePass2DGenerator : public IGenerator
	{
	// variables
	private:
	...
	// methods
	public:
		SinglePass2DGenerator (const SubSystemsRef ss) :
...
/*
=================================================
	Create_SinglePassRayTracing2D
=================================================
*/
	IGeneratorPtr  IGenerator::Create_SinglePassRayTracing2D (const SubSystemsRef ss)
	{
		return New< SinglePass2DGenerator >( ss );
	}
...
=================================================
*/
	bool SinglePass2DGenerator::SetArg (StringCRef name, const VariantRef &arg)
	{
...
=================================================
*/
	bool SinglePass2DGenerator::Compile ()
	{
...
=================================================
*/
	bool SinglePass2DGenerator::Load (uint index)
	{
		struct FileFilter
		{
		...
		if ( _files.Empty() )
		{
			OS::FileSystem::RecursiveFindFiles( "gl/Compute/SinglePassRayTracing2D", FileFilter(), 1, OUT _files );
		}
...
=================================================
*/
	void SinglePass2DGenerator::Render ()
	{
		CHECK( _outImage );
